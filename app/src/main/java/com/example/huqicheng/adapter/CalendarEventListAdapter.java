...
public class CalendarEventListAdapter extends BaseAdapter implements Filterable{
    ...
    public CalendarEventListAdapter(Context context, List<Event> eventList, User user) {
    ...
    public void add(List<Event> events,User user){
